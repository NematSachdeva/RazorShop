...
export function IconCart({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconFilter({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconClock({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconMapPin({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconHelp({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconInfo({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconPackage({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconMinus({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconStore({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function IconTag({ className = 'w-4 h-4', size }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="2"
        d="M7 7h.01M7 3h5a1 1 0 01.707.293l7 7a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-7-7A1 1 0 017 9V4a1 1 0 011-1z"
      />
    </svg>
  );
}
