  ...
  if (loading) {
    return (
      <div className={`bg-gray-50 p-4 rounded-xl border border-gray-100 ${className}`}>
        <div className="flex items-center justify-center py-4 text-xs font-semibold text-gray-600 font-sans">
  ...
  if (error) {
    return (
      <div className={`bg-gray-50 p-4 rounded-xl ${className}`}>
        <p className="text-xs text-gray-500 font-sans">Recommendations temporarily unavailable.</p>
      </div>
    );
  }
